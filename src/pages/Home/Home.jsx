    ...
    <div>
      ...
      <FadeContent blur={true} duration={500} easing="ease-out" initialOpacity={0}>
        <section className="text-center px-6 lg:pt-40 pt-32 pt bg-gradient-to-br from-light-blue via-white to-light-red h-screen font-montserrat">
            ...
            <span className="korean-pattern pointer-events-none absolute z-0 bottom-[8%] left-1/2 -translate-x-1/2 -rotate-[10deg] text-6xl opacity-20">
              시
            </span>
      ...
      <div className="lg:pt-18 pb-10 text-center p-5 flex-row justify-center bg-gradient-to-bl from-white  via-white to-light-blue">
        ...
        <div className="flex mx-auto bg-white rounded shadow-lg max-w-screen-lg flex-wrap justify-center">
          ...
          <div className="h-10 mt-12 mx-5 hidden md:block lg:block">
            <svg xmlns="http://www.w3.org/2000/svg" height="48px" viewBox="0 -960 960 960" width="48px" fill="#000"><path d="m600-200-42-42 208-208H80v-60h686L558-718l42-42 280 280-280 280Z"/></svg>
          </div>
          <div className="w-44 py-5">
            <div className="border boder-black w-28 p-5 rounded-full shadow text-center mx-auto bg-gradient-to-bl from-light-blue via-white to-light-red">
              <svg xmlns="http://www.w3.org/2000/svg" height="70px" viewBox="0 -960 960 960" width="70px" fill="#1f1f1f"><path d="M180-120q-24.75 0-42.37-17.63Q120-155.25 120-180v-600q0-24.75 17.63-42.38Q155.25-840 180-840h600q14 0 25.5 6t18.5 14l-44 44v-4H180v600h600v-343l60-60v403q0 24.75-17.62 42.37Q804.75-120 780-120H180Zm281-168L239-510l42-42 180 180 382-382 42 42-424 424Z"/></svg>
            </div>
            <div>
          ...
          <div className="w-44 py-5">
            <div className="border boder-black w-28 p-5 rounded-full shadow text-center mx-auto bg-gradient-to-bl from-light-blue via-white to-light-red">
              <svg xmlns="http://www.w3.org/2000/svg" height="70px" viewBox="0 -960 960 960" width="70px" fill="#1f1f1f"><path d="M120-120v-76l60-60v136h-60Zm165 0v-236l60-60v296h-60Zm165 0v-296l60 61v235h-60Zm165 0v-235l60-60v295h-60Zm165 0v-396l60-60v456h-60ZM120-356v-85l280-278 160 160 280-281v85L560-474 400-634 120-356Z"/></svg>
            </div>
            <div>
            ...
            <div>
              <div className="flex mx-auto  gap-10 max-w-screen-lg flex-wrap justify-center">
                <div className="w-72 py-5">
                  <div className=" border boder-black w-28 p-5 rounded-full shadow text-center mx-auto bg-gradient-to-bl from-light-blue via-white to-light-red">
                    <svg xmlns="http://www.w3.org/2000/svg" height="70px" viewBox="0 -960 960 960" width="70px" fill="#000000"><path d="m612-292 56-56-148-148v-184h-80v216l172 172ZM480-80q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-400Zm0 320q133 0 226.5-93.5T800-480q0-133-93.5-226.5T480-800q-133 0-226.5 93.5T160-480q0 133 93.5 226.5T480-160Z"/></svg>
                  </div>
                  <div>
                ...
                <div className="w-72 py-5">
                  <div className="border boder-black w-28 p-5 rounded-full shadow text-center mx-auto bg-gradient-to-bl from-light-blue via-white to-light-red">
                    <svg xmlns="http://www.w3.org/2000/svg" height="70px" viewBox="0 -960 960 960" width="70px" fill="#000000"><path d="M200-120q-17 0-28.5-11.5T160-160v-40q-50 0-85-35t-35-85v-200q0-50 35-85t85-35v-80q0-50 35-85t85-35h400q50 0 85 35t35 85v80q50 0 85 35t35 85v200q0 50-35 85t-85 35v40q0 17-11.5 28.5T760-120q-17 0-28.5-11.5T720-160v-40H240v40q0 17-11.5 28.5T200-120Zm-40-160h640q17 0 28.5-11.5T840-320v-200q0-17-11.5-28.5T800-560q-17 0-28.5 11.5T760-520v160H200v-160q0-17-11.5-28.5T160-560q-17 0-28.5 11.5T120-520v200q0 17 11.5 28.5T160-280Zm120-160h400v-80q0-27 11-49t29-39v-112q0-17-11.5-28.5T680-760H280q-17 0-28.5 11.5T240-720v112q18 17 29 39t11 49v80Zm200 0Zm0 160Zm0-80Z"/></svg>
                  </div>
                  <div>
                ...
                <div className="w-72 py-5">
                  <div className="border boder-black w-28 p-5 rounded-full shadow text-center mx-auto bg-gradient-to-bl from-light-blue via-white to-light-red">
                    <svg xmlns="http://www.w3.org/2000/svg" height="70px" viewBox="0 -960 960 960" width="70px" fill="#000000"><path d="M480-120q-42 0-71-29t-29-71q0-42 29-71t71-29q42 0 71 29t29 71q0 42-29 71t-71 29ZM254-346l-84-86q59-59 138.5-93.5T480-560q92 0 171.5 35T790-430l-84 84q-44-44-102-69t-124-25q-66 0-124 25t-102 69ZM84-516 0-600q92-94 215-147t265-53q142 0 265 53t215 147l-84 84q-77-77-178.5-120.5T480-680q-116 0-217.5 43.5T84-516Z"/></svg>
                  </div>
                  <div>
          ...
          <div>
            <div>
              <div className="flex mx-auto  gap-10 max-w-screen-lg flex-wrap justify-center">
                <div className="w-72 py-5">
                  <div className=" border boder-black w-28 p-5 rounded-full shadow text-center mx-auto bg-gradient-to-bl from-light-blue via-white to-light-red">
                    <svg xmlns="http://www.w3.org/2000/svg" height="70px" viewBox="0 -960 960 960" width="70px" fill="#000000"><path d="M360-120H200q-33 0-56.5-23.5T120-200v-280q0-75 28.5-140.5t77-114q48.5-48.5 114-77T480-840q75 0 140.5 28.5t114 77q48.5 48.5 77 114T840-480v280q0 33-23.5 56.5T760-120H600v-320h160v-40q0-117-81.5-198.5T480-760q-117 0-198.5 81.5T200-480v40h160v320Zm-80-240h-80v160h80v-160Zm400 0v160h80v-160h-80Zm-400 0h-80 80Zm400 0h80-80Z"/></svg>
                  </div>
                  <div>
                ...
                <div className="w-72 py-5">
                  <div className="border boder-black w-28 p-5 rounded-full shadow text-center mx-auto bg-gradient-to-bl from-light-blue via-white to-light-red">
                    <svg xmlns="http://www.w3.org/2000/svg" height="70px" viewBox="0 -960 960 960" width="70px" fill="#000000"><path d="M480-540ZM80-160v-80h400v80H80Zm120-120q-33 0-56.5-23.5T120-360v-360q0-33 23.5-56.5T200-800h560q33 0 56.5 23.5T840-720H200v360h280v80H200Zm600 40v-320H640v320h160Zm-180 80q-25 0-42.5-17.5T560-220v-360q0-25 17.5-42.5T620-640h200q25 0 42.5 17.5T880-580v360q0 25-17.5 42.5T820-160H620Zm100-300q13 0 21.5-9t8.5-21q0-13-8.5-21.5T720-520q-12 0-21 8.5t-9 21.5q0 12 9 21t21 9Zm0 60Z"/></svg>
                  </div>
                  <div>
                    <p className="mt-4 mb-2 font-extrabold font-montserrat">Baterai gadget terisi penuh</p>
                    <p className="font-opensans">Pastikan perangkat yang kamu gunakan tidak kehabisan daya di tengah try out.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="px-16 pb-10 bg-gradient-to-r from-light-blue pt-5  to-white">
        ...
        <ProductCard
          ...
          buttonText="Mulai"
            onButtonClick={() => navigate('/tryouts')}
        >
