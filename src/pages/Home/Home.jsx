  ...
  const Home = () => {
    ...
    if (hash) {
      ...
      if (el) {
        ...
        }, 200); // agar nunggu komponen selesai render
      }
    }
  }, []);
    ...
    return (
      <div>
        ...
        <div id="steps" className="lg:pt-18 pb-10 text-center p-5 flex-row justify-center bg-gradient-to-bl from-white  via-white to-light-blue">
