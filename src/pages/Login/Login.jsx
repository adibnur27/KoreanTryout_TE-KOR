  ...
  const onSubmit = async (data) => {
    try {
      ...
      Swal.fire({
        icon: "error",
        title: "Login Gagal",
        text: err.message?.includes("not verified") || err.message?.includes("belum terverifikasi") ? "Email kamu belum diverifikasi. Cek email kamu untuk aktivasi." : err.message || "Username atau Password salah.",
