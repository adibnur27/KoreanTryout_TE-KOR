  ...
  const onSubmit = async (data) => {
    try {
      ...
      Swal.fire({
        ...
        text: "Silakan cek email kamu untuk verifikasi sebelum masuk.",
        icon: "success",
      ...
      if (err.response) {
        ...
        if (data && typeof data === "object") {
          const validationMessages = Object.values(data).flat().join(", ");
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-2">
            ...
            <div className="relative">
              <input
                ...
                {...register("password")}
                className="w-full border border-kr-blue rounded-md p-3 pr-10 focus:outline-none"
              />
              <button
                type="button"
