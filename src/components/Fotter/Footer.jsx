...
const Footer = () => {
  ...
  return (
    <footer className=" flex justify-center items-center gap-6 p-5 text-lg bg-blue-950 text-white">
      <div className=" w-1/2  ">
        ...
        <div className="flex gap-5  mt-5 mb-2 pb-3 border-b-white border-b-2 justify-center">
        ...
        <p className="text-center my-2">Built with care by <span className="font-semibold">AHERA</span> Team</p>
      </div>
      <div className="">
